...
//                             bidsAfterUpdate[i][0] = data.bids[j][1];
//                             break;
//                         }
...
//                         if (asksAfterUpdate[i][0] === data.asks[j][1]) {
...
//             });
//         }, `DEPTH-${market}`)
//         SignalingManager.getInstance().sendMessage({ "message": "SUBSCRIBE", "params": [`depth.${market}`] });
...
//         {price && <div className="bg-green-950">{price}</div>}
//         {bids && <BidTable bids={bids}></BidTable>}
//     </div>
// }
